...
class NonePatternTest < Minitest::Test
  ...
  def test_none_are_negative
    ...
    none_negative = true
    numbers.each do |num|
      none_negative = false unless num.positive?
    end
  ...
  def test_none_shall_pass
    ...
    critters.each do |critter|
      none_shall_pass = false unless critters.include?(critter)
    end
  ...
  def test_one_or_more_shall_pass
    ...
    phrases.each do |phrase|
      none_shall_pass = false unless phrase == "shall pass"
    end
  ...
  def test_none_even
    ...
    none_even = true
    numbers.each do |num|
      none_even = false unless num.odd?
    end
    assert none_even
  end
